...
# Ajouter des étiquettes pour les symboles des joueurs
label1 = tk.Label(root, text="Joueur 1: X", font=('normal', 20,))
label1.grid(row=0, column=0, columnspan=3)

label2 = tk.Label(root, text="Joueur 2: O", font=('normal', 20))
label2.grid(row=0, column=3, columnspan=3)

# Création des boutons
bouton1 = tk.Button(root, text="", font=('normal', 20),bg="blue",width=5, height=2,command=lambda: verification(1))
bouton1.grid(row=1, column=0)

bouton2 = tk.Button(root, text="", font=('normal', 20),bg="white", width=5, height=2, command=lambda: verification(2))
bouton2.grid(row=1, column=1)

bouton3 = tk.Button(root, text="", font=('normal', 20),bg="blue", width=5, height=2, command=lambda: verification(3))
bouton3.grid(row=1, column=2)

bouton4 = tk.Button(root, text="", font=('normal', 20),bg="white", width=5, height=2, command=lambda: verification(4))
bouton4.grid(row=2, column=0)

bouton5 = tk.Button(root, text="", font=('normal', 20),bg="blue", width=5, height=2, command=lambda: verification(5))
bouton5.grid(row=2, column=1)

bouton6 = tk.Button(root, text="", font=('normal', 20),bg="white", width=5, height=2, command=lambda: verification(6))
bouton6.grid(row=2, column=2)

bouton7 = tk.Button(root, text="", font=('normal', 20),bg="blue",width=5, height=2,command=lambda: verification(7))
bouton7.grid(row=3, column=0)

bouton8 = tk.Button(root, text="", font=('normal', 20),bg="white", width=5, height=2, command=lambda: verification(8))
bouton8.grid(row=3, column=1)

bouton9 = tk.Button(root, text="", font=('normal', 20),bg="blue", width=5, height=2, command=lambda: verification(9))
